...
# Step 2: Connect and check current schema
./scripts/database/psql-cloud.sh
postgres=> \dn
postgres=> \dt elections.*

# Step 3: Run migration SQL
postgres=> \i services/elections/migrations/004_move_to_elections_schema.sql

# Step 4: Verify changes
postgres=> \dt elections.*
postgres=> SELECT COUNT(*) FROM elections.ballots;
```
