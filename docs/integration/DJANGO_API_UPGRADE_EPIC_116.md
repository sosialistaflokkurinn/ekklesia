...
-- Example output:
-- 2025-10-28 17:22:44 | 3 | 813: Jón | Updated via Epic #116 Admin UI
```
...
curl -s -X PATCH https://starf.sosialistaflokkurinn.is/felagar/api/full/813/ \
  ...
  -H "Content-Type: application/json" \
  -d '{"name": "Jón Jónsson - Epic 116 Test"}'

# Response: 200 OK (name updated)
{
  "id": 813,
  "name": "Jón Jónsson - Epic 116 Test",
  ...
}
```
...
# Expected: {"street": "Laufásvegur", "number": 5, "postal_code": 112, "city": "Reykjavík"}
# Broken:   None
```
