...
1. Execute load testing for 300 votes/second spike (see [Usage Context](../../development/guides/workflows/USAGE_CONTEXT.md)).
2. Rehearse meeting-day runbook ([Operational Procedures](../../operations/OPERATIONAL_PROCEDURES.md)).
3. Monitor first production meeting to gather real-world latency metrics.

## Related Documentation

- [Usage Context](../../development/guides/workflows/USAGE_CONTEXT.md) – Load patterns and scaling expectations
- [Operational Procedures](../../operations/OPERATIONAL_PROCEDURES.md) – Meeting-day checklist
- [Cloud Run Services](../../infrastructure/CLOUD_RUN_SERVICES.md) – Service deployment details
