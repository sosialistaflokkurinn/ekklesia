...
async function init() {
  try {
    ...
    // Set tabs text (mobile nav drawer)
    document.getElementById('nav-tab-all-text').textContent = R.string.tab_all_elections;
    document.getElementById('nav-tab-policy-text').textContent = R.string.tab_policy_sessions;
    document.getElementById('nav-tab-candidate-text').textContent = R.string.tab_candidate_elections;
