...
export class SearchableSelect {
  ...
  constructor(selectElement, options = {}) {
    ...
    this.options = {
      placeholder: options.placeholder || R.string?.select_placeholder || DEFAULT_STRINGS.placeholder,
      searchPlaceholder: options.searchPlaceholder || R.string?.select_search_placeholder || DEFAULT_STRINGS.search_placeholder,
      noResultsText: options.noResultsText || R.string?.select_no_results || DEFAULT_STRINGS.no_results,
