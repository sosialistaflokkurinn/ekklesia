 ...
 * @param {Function} [options.api.submitAmendment] - Custom submitAmendment function
 * @returns {Object} - Form API {element, reset, destroy}
 */
export function createAmendmentForm({ sections, sessionId, R, onSubmitSuccess, api }) {
  // Use provided API or default
  const submitAmendment = api?.submitAmendment || defaultSubmitAmendment;
  // Validate inputs
