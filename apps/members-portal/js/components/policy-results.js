...
import { showErrorIn } from './ui-error.js';
import { R } from '../../i18n/strings-loader.js';
import { getPolicyResults as defaultGetPolicyResults } from '../api/api-elections.js';
 ...
 * @param {Function} [options.api.getPolicyResults] - Custom getPolicyResults function
...
export function createPolicyResultsDisplay(options = {}) {
  ...
  const getPolicyResults = api?.getPolicyResults || defaultGetPolicyResults;
