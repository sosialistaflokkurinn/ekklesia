...
/**
 * Default i18n strings for the modal component
 * Can be overridden by R.string values
 */
...
function getString(key) {
  return R.string?.[`modal_${key}`] || DEFAULT_STRINGS[key];
}
...
export function showModal(options = {}) {
  ...
  const closeButton = el('button', 'modal__close', {
    'aria-label': getString('close_aria'),
