...
const DEFAULT_STRINGS = {
  suggestions_aria: 'Tillögur að heimilisföngum'
};
...
export class AddressAutocomplete {
  ...
  constructor(inputElement, options = {}) {
    ...
    this.debounceMs = options.debounceMs || 150;  // Faster response (was 300)
  ...
  init() {
    ...
    this.dropdown.setAttribute('aria-label', R.string?.address_suggestions_aria || DEFAULT_STRINGS.suggestions_aria);
